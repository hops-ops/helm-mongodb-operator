...
PACKAGE ?= helm-mongodb-operator
XRD_DIR := apis/mongodboperators
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/mongodboperators/standard.yaml
...
render\:%:
	@example="examples/mongodboperators/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
